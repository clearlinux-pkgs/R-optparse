...
Version  : 1.4.4
Release  : 6
URL      : https://cran.r-project.org/src/contrib/optparse_1.4.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/optparse_1.4.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521237900
...
/usr/lib64/R/library/optparse/NEWS
